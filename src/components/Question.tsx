  ...
  const faqs = [
    {
      ...
      answer: '基本的に安全な公園や屋外スペース（例：Albert Park）で行っています。屋外で行うことで、風を感じながら体と心をリラックスさせる特別な体験ができます。',
      icon: '🍃'
    },
    {
      question: '屋内での施術は可能ですか?',
      answer: '初めての屋内施術の場合は、安全な公共の場所での利用を推奨しています。個人宅での施術については、施術者の経験に基づいた相談となります。',
      icon: '🏠'
    },
    {
      question: '車はありますか?',
      answer: '車は所有していないため、基本的にCBD（中心街）や公共交通機関の範囲内での施術となります。遠方への訪問や屋内施術の場合、安全と利便性のため別途交通費をいただく場合があります。',
      icon: '🚶'
    },
    {
    ...
    <div className="mt-16 mb-16 md:mt-24">
      ...
      <div className="space-y-6">
        {faqs.map((faq, index) => (
          <div
            key={index}
            className="bg-amber-50 border border-amber-200 rounded-lg p-6 md:p-8"
          >
